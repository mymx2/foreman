---
name: english
description: Quiet English correction rules for a non-native speaker. Appends inline corrections for real grammar or phrasing mistakes while staying silent on Chinese-only messages, code, URLs, and already-natural English.
trigger: always_on
alwaysApply: true
metadata:
