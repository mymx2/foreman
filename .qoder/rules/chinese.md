---
name: chinese
description: Deterministic rules to eliminate high-frequency AI-flavored Chinese phrasing patterns such as formulaic closings, three-part structures, and report-style transitions. Applies to all Chinese output in every session.
trigger: always_on
alwaysApply: true
metadata:
