...
description: Shared preamble for every skill that reads optional memory or prior-decision context. Defines when to read durable context, read order and budget, memory redaction gates, and type mapping rules.
trigger: always_on
alwaysApply: true
metadata:
